...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <!--[if lt IE 9]>
    <script src="resources/material/global/vendor/html5shiv/html5shiv.min.js"></script>
    <![endif]-->
    
    <!--[if lt IE 10]>
    <script src="resources/material/global/vendor/media-match/media.match.min.js"></script>
    <script src="resources/material/global/vendor/respond/respond.min.js"></script>
    <![endif]-->
                      ...
                      <ul class="blocks-3">
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">
                            <img class="w-full" src="resources/material/global/photos/placeholder.png" alt="..." />
                          </a>
                        </li>
                        <li>
                          <a class="thumbnail m-0" href="javascript:void(0)">

    ...
    [
    	...
    	},
    	{
    		...
    		value: function handleSelective()
    		{
    			...
    			let members=JSON.parse(sessionStorage.getItem("allMemberId"));
    			...
    			{		
    				...
    				tpl: 
    				{
    					...
    					{  	
    						// 회원의 모든 정보를 리스트로 가져옴
    						return "<li class=\"".concat(this.namespace, "-list-item\"><button class=\"btn btn-round btn-info btn-sm\" value = \"" + data.id + "\">" + data.id ).concat(data.id, "</li>");
    					},
    					item: function item(data)
    					{
    						// 회원 하나를 하나의 버튼으로
    						return "<li class=\"".concat(this.namespace, "-item\"><button class=\"btn btn-round btn-info btn-sm\" value = \"" + data.id + "\">" + data.id).concat(this.options.tpl.itemRemove.call(this), "</li>");
    					},
    					...
    					{
    						return "<option value=\"" +data.id + "\">".concat(data.id, "</option>");

   						//  return "<option value=\"".concat(this.options.tpl.optionValue.call(this, data.id), "\">").concat(data.id, "</option>");
    					}
    				}
    			});
    		}
